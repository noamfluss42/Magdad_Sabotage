...
export class YearlySummaryScreenComponent implements OnInit {
  ...
  eventsByCategories_count_weaponsYearly: number = 8;
  eventsByCategories_count_explosive_deviceYearly: number = 9;
  eventsByCategories_count_fireworksYearly: number = 10;
  eventsByCategories_count_queryYearly: number = 11;
